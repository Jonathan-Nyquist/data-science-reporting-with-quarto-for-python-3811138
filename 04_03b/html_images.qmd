...
![](palmer-penguins_by-allison-horst.png){width="50px"}

Using explicit HTML

<img src="palmer-penguins_by-allison-horst.png" width="30%"/>

# Fancier image insertion

::: {.container}

<img style="float: left; margin-right: 10px;" src="palmer-penguins_by-allison-horst.png" width="30%">
